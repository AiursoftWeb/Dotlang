...
public class GenerateResxForDataAnnotationsHandler : ExecutableCommandHandlerBuilder
{
    ...
    protected override string Name => "generate-resx-annotations";

    protected override string Description => "The command to start translation for DataAnnotation attributes in a .NET project.";
